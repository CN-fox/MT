...
static const char qt_meta_stringdata_Test[] = {
    "Test\0\0on_comboBox_activated(QString)\0"
    "on_getbug_clicked()\0finished(QNetworkReply*)\0"
};
...
int Test::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_comboBox_activated((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: on_getbug_clicked(); break;
